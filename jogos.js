...
/* 87 - BROTHERS A TALE OF TWO SONS */
{
    ...
    image: "images/brothers-tale-of-two-sons.jpg",

    description: "An emotional adventure about two brothers on an unforgettable journey.",

    requirements: {
        android: "12+",
        ram: "2GB",
        cpu: "Dual Core+",
        gpu: "Adreno, Mali, PowerVR and Tegra",
        storage: "700MB"
    },

    info: "Works normally on Android 12 and 13. Android 14, 15 and 16 may require VPhoneOS. Choose the correct version for your GPU.",
...
/* 88 - THE WALKING DEAD SEASON ONE ANDROID 14 */
{
    ...
    description: "The first season of The Walking Dead, updated for Android 14.",
    ...
    info: "Updated version for Android 14, available for Adreno, Mali, PowerVR and Tegra GPUs. This version is in Spanish. Android 15 and 16 may have compatibility issues.",
...
/* 89 - REAL RACING 3 */
{
    ...
    image: "images/real-racing-3.jpg",

    description: "A realistic racing game featuring licensed cars, famous tracks and advanced graphics.",

    requirements: {
        android: "8+",
        ram: "2GB",
        cpu: "Compatible",
        gpu: "Adreno, Mali or PowerVR",
        storage: "8GB, 20GB free space recommended"
    },
...
This tutorial was created to help players install and enjoy the classic offline version of the game.
...
• No new updates.
• No online events.
• No features that require servers.
• Compatibility may vary depending on the device.

 REQUIREMENTS 

• ZArchiver file manager is recommended.
• Follow the installation tutorial carefully.
• Android 8 up to Android 16.
• Recommended device with arm64-v8a architecture.
• 32-bit devices may have compatibility issues.
• Be careful when moving or renaming the "data" folder.
    ...
    downloads: [
        {
            ...
            type: "Information",
            url: "https://youtu.be/rJ0QuWh2b18?is=Q7lImrcJPJtFeWA0"
        },
